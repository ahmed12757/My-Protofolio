...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full overflow-hidden">
        <div className="relative bg-black h-screen  ">
          ...
          <div className="relative z-50 flex items-center justify-between w-full py-2 border-b bg-neutral-950 border-neutral-800">
            <div className="grid items-center w-full grid-cols-12 px-5 md:px-20">
              ...
              <div className="items-center hidden col-span-8 gap-6 text-lg md:flex md:text-2xl text-white/50 ms-auto">
    ...
    `}
            ...
            >
              {sections.map((section) => (
                <button
                  ...
                  className="block w-full py-2 transition-colors duration-200 hover:bg-neutral-800"
                >
                  {section.charAt(0).toUpperCase() + section.slice(1)}
                </button>
              ))}
          ...
          <div className="relative z-40 flex flex-col items-center justify-center pt-20 pb-32">
            <motion.img
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <span className="text-xl ">available for work</span>
            </motion.p>
            <motion.h1
            ...
            {/* Social Icons */}
            <motion.div
              className="flex items-center mt-4 text-xl text-gray-400 gap-7"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
